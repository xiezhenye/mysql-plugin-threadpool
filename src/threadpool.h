...
//uint threadpool_min_threads;  /* Minimum threads in pool */
//uint threadpool_idle_timeout; /* Shutdown idle worker threads  after this timeout */
//uint threadpool_size; /* Number of parallel executing threads */
//uint threadpool_stall_limit;  /* time interval in 10 ms units for stall checks*/
//uint threadpool_max_threads;  /* Maximum threads in pool */
//uint threadpool_oversubscribe;  /* Maximum active threads in group */
